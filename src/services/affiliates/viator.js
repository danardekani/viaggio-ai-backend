...
const POPULAR_DESTINATIONS = [
  ...
  { id: 463, name: 'Copenhagen' },
  { id: 907, name: 'Stockholm' },
  { id: 458, name: 'Brussels' },
  { id: 478, name: 'Nice' },
  { id: 946, name: 'Amalfi Coast' },
  { id: 22149, name: 'Cinque Terre' },
  ...
  { id: 673, name: 'Chicago' },
  { id: 678, name: 'Boston' },
  { id: 675, name: 'New Orleans' },
  { id: 657, name: 'Washington DC' },
  { id: 704, name: 'Seattle' },
  { id: 663, name: 'Orlando' },
  { id: 736, name: 'San Diego' },
  { id: 799, name: 'Nashville' },
  { id: 5021, name: 'Austin' },
  { id: 4837, name: 'Denver' },
  { id: 906, name: 'Philadelphia' },
  { id: 639, name: 'Phoenix' },
  { id: 661, name: 'Key West' },
  { id: 5166, name: 'Savannah' },
  { id: 4384, name: 'Charleston' },
  { id: 666, name: 'Napa Valley' }, // Maps to San Francisco (Napa tours are day trips from SF)
  { id: 4382, name: 'Portland' },
  { id: 750, name: 'Sedona' },
  { id: 815, name: 'Grand Canyon' },
  ...
  { id: 921, name: 'Jerusalem' },
  { id: 920, name: 'Tel Aviv' },
  ...
  { id: 618, name: 'Sydney' },
  { id: 561, name: 'Cancun' },
  { id: 50859, name: 'Cabo San Lucas' },
  { id: 905, name: 'Reykjavik' },
  { id: 671, name: 'Maui' },
  { id: 384, name: 'Melbourne' },
  { id: 391, name: 'Auckland' },
  { id: 407, name: 'Queenstown' },
  { id: 23, name: 'Fiji' },
  { id: 318, name: 'Cape Town' },
  { id: 5408, name: 'Marrakech' },
  { id: 782, name: 'Cairo' },
  { id: 585, name: 'Istanbul' },
  { id: 712, name: 'Rio de Janeiro' },
  { id: 901, name: 'Buenos Aires' },
  { id: 928, name: 'Lima' },
  { id: 4498, name: 'Cartagena' },
  { id: 630, name: 'Puerto Vallarta' },
  { id: 5501, name: 'Playa del Carmen' },
  { id: 34, name: 'Jamaica' },
  { id: 28, name: 'Aruba' },
  { id: 29, name: 'Bahamas' },
  { id: 51002, name: 'Puerto Rico' },
  { id: 747, name: 'Costa Rica' },
  { id: 950, name: 'Panama City' },
];
